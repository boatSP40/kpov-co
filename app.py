...
file_source = r"\\172.25.70.18\PE-  Budo Urgent Normal Item\Boat18\COATING\Excursion\20231121 SU23 CoatNG\SU23.xlsx"
...
# layer_no = st.sidebar.multiselect(
#     "Select the Coated Layer:",
#     options=df["Layer_No"].unique(),
#     default=df["Layer_No"].unique()
# )
...
#                                                mode="lines", name=f"OPM_light_quantity - Date_Coat: {date_coat}"))
#     opm_press_line_plotly.add_trace(go.Scatter(x=x_values, y=group["Pressure"],
#                                                mode="lines", name=f"Pressure - Date_Coat: {date_coat}", yaxis="y2"))
...
#                                                mode="lines", name=f"Source_current - Date_Coat: {date_coat}"))
#     sc_rate_line_plotly.add_trace(go.Scatter(x=x_values, y=group["Rate_A_sec"],
#                                                mode="lines", name=f"Rate_A_sec - Date_Coat: {date_coat}", yaxis="y2"))
...
#                                                mode="lines", name=f"Pressure - Date_Coat: {date_coat}"))
#     press_flow_line_plotly.add_trace(go.Scatter(x=x_values, y=group["Flow"],
#                                                mode="lines", name=f"Flow - Date_Coat: {date_coat}", yaxis="y2"))
